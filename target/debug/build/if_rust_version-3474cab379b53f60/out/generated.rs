...
macro_rules! if_rust_version_impl {
    ...
    (>= 1.50 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.51 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.52 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.53 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.54 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= 1.55 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (>= $n:tt { $($if_:tt)* } { $($else_:tt)* } ) => { $($else_)* };
    (== 1.55 { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (== nightly { $($if_:tt)* } { $($else_:tt)* }) => { $($if_)* };
    (== $n:tt { $($if_:tt)* } { $($else_:tt)* }) => { $($else_)* };
    (> 1.55 { $($if_:tt)* } { $($else_:tt)* }) => { $($else_)* };
